...
export const POKEMON_LIST = [
  ...
  "Arbok","Pikachu","Raichu","Raichu-Alola","Clefable","Ninetales","Ninetales-Alola",
  "Arcanine","Arcanine-Hisui","Alakazam","Mega Alakazam","Machamp","Victreebel",
  "Slowbro","Slowbro-Galar","Mega Slowbro","Gengar","Mega Gengar","Kangaskhan","Mega Kangaskhan",
  "Starmie","Mega Starmie","Pinsir","Tauros","Tauros-Paldea-Combat","Tauros-Paldea-Blaze","Tauros-Paldea-Aqua",
  "Gyarados","Mega Gyarados","Ditto","Vaporeon","Jolteon","Flareon","Aerodactyl","Mega Aerodactyl",
  "Snorlax","Dragonite","Mega Dragonite",
  // Gen 2 base + Megas
  "Meganium","Mega Meganium","Typhlosion","Typhlosion-Hisui","Mega Typhlosion","Feraligatr","Mega Feraligatr",
  "Ariados","Ampharos","Mega Ampharos","Azumarill","Politoed","Espeon","Umbreon",
  "Slowking","Slowking-Galar","Forretress","Steelix","Mega Steelix","Scizor","Mega Scizor",
  "Heracross","Mega Heracross","Skarmory","Mega Skarmory","Houndoom","Mega Houndoom","Tyranitar","Mega Tyranitar",
  // Gen 3 base + Megas
  "Pelipper","Gardevoir","Mega Gardevoir","Sableye","Mega Sableye","Aggron","Mega Aggron",
  ...
  "Banette","Mega Banette","Chimecho","Absol","Mega Absol","Glalie","Mega Glalie",
  "Salamence","Mega Salamence",
  // Gen 4 base + Megas
  "Torterra","Infernape","Empoleon","Luxray","Roserade","Rampardos","Bastiodon",
  "Lopunny","Mega Lopunny","Spiritomb","Garchomp","Mega Garchomp","Lucario","Mega Lucario",
  "Hippowdon","Toxicroak","Abomasnow","Mega Abomasnow","Weavile","Rhyperior",
  "Leafeon","Glaceon","Gliscor","Mamoswine","Gallade","Mega Gallade",
  "Froslass","Mega Froslass","Rotom","Rotom-Heat","Rotom-Wash","Rotom-Frost","Rotom-Fan","Rotom-Mow",
  // Gen 5 base + Megas
  "Serperior","Emboar","Samurott","Samurott-Hisui","Watchog","Liepard","Simisage","Simisear","Simipour",
  "Excadrill","Audino","Mega Audino","Conkeldurr","Whimsicott","Krookodile","Cofagrigus",
  "Garbodor","Zoroark","Zoroark-Hisui","Reuniclus","Vanilluxe","Emolga","Chandelure",
  "Beartic","Stunfisk","Stunfisk-Galar","Golurk","Mega Golurk","Hydreigon","Volcarona",
  // Gen 6 base + Megas
  "Chesnaught","Mega Chesnaught","Delphox","Mega Delphox","Greninja","Mega Greninja",
  "Diggersby","Talonflame","Vivillon","Florges","Hawlucha","Mega Hawlucha",
  "Goodra","Mega Goodra","Klefki","Trevenant","Gourgeist","Mega Gourgeist","Noivern",
  "Aegislash","Sylveon","Heliolisk","Meowstic","Mega Meowstic","Floette-Eternal",
  // Gen 7 base + Megas
  "Decidueye","Mega Decidueye","Incineroar","Mega Incineroar","Primarina","Mega Primarina",
  "Lycanroc","Lycanroc-Midnight","Lycanroc-Dusk","Wishiwashi","Salazzle","Oranguru",
  "Passimian","Kommo-o","Mimikyu","Dhelmise","Palafin",
  // Gen 8 base + Megas
  "Corviknight","Mega Corviknight","Coalossal","Sandaconda","Hatterene","Grimmsnarl",
  "Obstagoon","Runerigus","Alcremie","Falinks","Eiscue","Duraludon","Dragapult","Mega Dragapult",
  "Wyrdeer","Kleavor","Ursaluna","Basculegion","Sneasler","Overqwil",
  // Gen 9 base + Megas
  "Meowscarada","Mega Meowscarada","Skeledirge","Mega Skeledirge","Quaquaval","Mega Quaquaval",
  "Farigiraf","Tinkaton","Kingambit","Baxcalibur","Gholdengo","Armarouge","Ceruledge",
  "Maushold","Scovillain","Mega Scovillain","Espathra","Glimmora","Annihilape","Clodsire",
  "Greedent","Sinistcha","Archaludon","Mega Archaludon","Hydrapple","Dondozo","Tatsugiri","Rabsca",
];
