...
export const ALL_POKEMON = [
  ...
  {name:'Mega Meowstic',        base:124, isMega:true,  types:['Psychic']},
  ...
  // Base 90
  {name:'Electivire',           base:95,  isMega:false, types:['Electric']},
  ...
  {name:'Mega Metagross',       base:110, isMega:true,  types:['Steel','Psychic']},
  // Base 87
  ...
  {name:'Mega Lucario (pre)',   base:90,  isMega:false, types:['Fighting','Steel']},
  ...
  {name:'Togekiss',             base:80,  isMega:false, types:['Fairy','Flying']},
  ...
  {name:'Metagross',            base:70,  isMega:false, types:['Steel','Psychic']},
  ...
  {name:'Mismagius',            base:105, isMega:false, types:['Ghost'], isGhost:true},
  {name:'Drifblim',             base:80,  isMega:false, types:['Ghost','Flying'], isGhost:true},
  ...
  {name:'Hitmontop',            base:70,  isMega:false, types:['Fighting']},
  ...
  {name:'Dusknoir',             base:45,  isMega:false, types:['Ghost'], isGhost:true},
  {name:'Armarouge',            base:75,  isMega:false, types:['Fire','Psychic']},
  {name:'Latias',               base:110, isMega:false, types:['Dragon','Psychic']},
  {name:'Latios',               base:110, isMega:false, types:['Dragon','Psychic']},
  {name:'Flyeon',               base:95,  isMega:false, types:['Bug','Flying']},
  {name:'Talonflame',           base:126, isMega:false, types:['Fire','Flying']},
